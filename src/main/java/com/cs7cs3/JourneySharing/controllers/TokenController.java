...
//      token:  btV5NwilFF9Ky67YjJxdxLH0JjOKks7pjyf0u8ctpcgWo+gP1L1m4p99n0J62HdV8kTPzXaPcQY2/sk7lvF3/15kwuXNQGT19IYlRttsS4E=
    ...
    public Response<GetInfoByTokenResponse> getInfo(@RequestBody Request<GetInfoByTokenRequest> req) {
        var id = Utils.getIdByToken(req.getToken());
        if (id.isEmpty()) {
